...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/project-name
   cd project-name
   ```
...
```sh
https://github.com/flex-development/project-name/compare/main...$branch
```
...
[17]: https://github.com/flex-development/project-name/discussions/new?category=q-a
